        ...
        return async function* streamData() {
            ...
            while (true) {
                ...
                for (let event of eventList) {
                    ...
                    const unfinishedPairs = findUnfinishedPairsAll(getMessage)
